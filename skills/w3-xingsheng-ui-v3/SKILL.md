...
Use this v3 skill to collect structured data from Xinsheng pages with a visible browser, Windows local Chrome-first launch strategy, and login-state troubleshooting guidance.
